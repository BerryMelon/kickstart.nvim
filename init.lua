...
-- Root folder for where telescope should search
vim.g.projectroot = ''
...
-- Center cursor when jumping up or down
vim.keymap.set('n', '<C-d>', '<C-d>zz', {})
vim.keymap.set('n', '<C-u>', '<C-u>zz', {})

-- Resizing helpers
vim.keymap.set('n', '>>', '<C-w>30>', { desc = 'Larger Window' })
vim.keymap.set('n', '<<', '<C-w>30<', { desc = 'Smaller Window' })
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sf', function()
        builtin.find_files { cwd = vim.g.projectroot }
      end, { desc = '[S]earch [F]iles' })
      vim.keymap.set('n', '<leader>ss', builtin.builtin, { desc = '[S]earch [S]elect Telescope' })
      vim.keymap.set('n', '<leader>sw', builtin.grep_string, { desc = '[S]earch current [W]ord' })
      vim.keymap.set('n', '<leader>sg', function()
        builtin.live_grep { cwd = vim.g.projectroot }
      end, { desc = '[S]earch by [G]rep' })
      vim.keymap.set('n', '<leader>s+', builtin.diagnostics, { desc = '[S]earch Diagnostics [+]' })
      ...
      vim.keymap.set(
        'n',
        '<leader>sb',
        ':Telescope file_browser path=%:p:h select_buffer=true depth=2 auto_depth=true grouped=true<CR>',
